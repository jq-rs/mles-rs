...
An Mles proxy-client MAY proxy a selected channel data between several Mles servers. Mles servers see proxy sessions as any other Mles client sessions. This allows Mles proxy-client to share and distribute value triplet data in an organized and powerful, yet simple manner between several Mles servers.
